...
# Read File
#----------------------------------------------------#
dfm <-  readRDS('~/collab/CCU043/data/ccu043_01_survival_cohort_bhf_f.rds')
...
fwrite(m_hf_bmi,'~/collab/CCU043/output/BHF/CCU043_01_bhf_t1_predicted_hazard_bmi_female.csv')
m_hf_bmi <- read.csv('~/collab/CCU043/output/BHF/CCU043_01_bhf_t1_predicted_hazard_bmi_female.csv',
                     header = TRUE, sep = ",")
...
m_hf_bmi$rbmi_lb <- m_hf_bmi$lower    * 1000
m_hf_bmi$rbmi_ub <- m_hf_bmi$upper    * 1000
fwrite(m_hf_bmi,'~/collab/CCU043/output/BHF/CCU043_01_bhf_t1_predicted_hazard_bmitvc_female.csv')
m_hf_bmi <- read.csv('~/collab/CCU043/output/BHF/CCU043_01_bhf_t1_predicted_hazard_bmitvc_female.csv',
                     header = TRUE, sep = ",")
m_hf_bmi$bmiv    <- as.factor(m_hf_bmi$bmi_value)
m_hf_bmi$expv    <- as.factor(m_hf_bmi$exposed)
ggplot(m_hf_bmi, 
...
fwrite(m_hf_imd,'~/collab/CCU043/output/BHF/CCU043_01_bhf_t1_predicted_hazard_imd_female.csv')
m_hf_imd <- read.csv('~/collab/CCU043/output/BHF/CCU043_01_bhf_t1_predicted_hazard_imd_female.csv',
                     header = TRUE, sep = ",")
...
m_hf_imd$rimd_lb <- m_hf_imd$lower    * 1000
m_hf_imd$rimd_ub <- m_hf_imd$upper    * 1000
fwrite(m_hf_imd,'~/collab/CCU043/output/BHF/CCU043_01_bhf_t1_predicted_hazard_imdtvc_female.csv')
m_hf_imd <- read.csv('~/collab/CCU043/output/BHF/CCU043_01_bhf_t1_predicted_hazard_imdtvc_female.csv',
                     header = TRUE, sep = ",")
m_hf_imd$imdv    <- as.factor(m_hf_imd$imd)
m_hf_imd$expv    <- as.factor(m_hf_imd$exposed)
ggplot(m_hf_imd, 
...
fwrite(m_hf_eth,'~/collab/CCU043/output/BHF/CCU043_01_bhf_t1_predicted_hazard_eth_female.csv')
m_hf_eth <- read.csv('~/collab/CCU043/output/BHF/CCU043_01_bhf_t1_predicted_hazard_eth_female.csv',
                     header = TRUE, sep = ",")
...
m_hf_eth$reth_lb <- m_hf_eth$lower    * 1000
m_hf_eth$reth_ub <- m_hf_eth$upper    * 1000
fwrite(m_hf_eth,'~/collab/CCU043/output/BHF/CCU043_01_bhf_t1_predicted_hazard_ethtvc_female.csv')
m_hf_eth <- read.csv('~/collab/CCU043/output/BHF/CCU043_01_bhf_t1_predicted_hazard_ethtvc_female.csv',
                     header = TRUE, sep = ",")
m_hf_eth$ethv    <- as.factor(m_hf_eth$eth)
m_hf_eth$expv    <- as.factor(m_hf_eth$exposed)
ggplot(m_hf_eth, 
...
fwrite(m_hf_reg,'~/collab/CCU043/output/BHF/CCU043_01_bhf_t1_predicted_hazard_reg_female.csv')
m_hf_reg <- read.csv('~/collab/CCU043/output/BHF/CCU043_01_bhf_t1_predicted_hazard_reg_female.csv',
                     header = TRUE, sep = ",")
...
m_hf_reg$rreg_lb <- m_hf_reg$lower    * 1000
m_hf_reg$rreg_ub <- m_hf_reg$upper    * 1000
fwrite(m_hf_reg,'~/collab/CCU043/output/BHF/CCU043_01_bhf_t1_predicted_hazard_regtvc_female.csv')
m_hf_reg <- read.csv('~/collab/CCU043/output/BHF/CCU043_01_bhf_t1_predicted_hazard_regtvc_female.csv',
                     header = TRUE, sep = ",")
m_hf_reg$regv    <- as.factor(m_hf_reg$reg)
m_hf_reg$expv    <- as.factor(m_hf_reg$exposed)
ggplot(m_hf_reg, 
