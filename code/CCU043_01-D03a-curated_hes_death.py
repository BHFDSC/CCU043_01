...
# MAGIC %md 
# MAGIC # CCU043_01-D03a-curated_hes_death
# MAGIC
# MAGIC **Project** CCU043_01
# MAGIC
...
# MAGIC
# MAGIC **Data Output**
# MAGIC - **`ccu043_01_cur_hes_apc_all_years_archive_long`** : HES APC codes in long format
# MAGIC - **`ccu043_01_archive_sing`** : Death codes in wide format (one row per person)
# MAGIC - **`ccu043_01_archive_long`** : Death codes in long format
# MAGIC - **`ccu043_01_cur_gdppr`** : GDPPR curated with a monotonically increasing ID
...
save_table(df=deaths_out_sing, out_name=f'{proj}_cur_deaths_sing', save_previous=False)

# COMMAND ----------

save_table(df=deaths_out_long, out_name=f'{proj}_cur_deaths_long', save_previous=False)